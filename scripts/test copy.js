...
let attack = {
    ...
    c.lineTo(x2 + (Math.sin(num) * 10) + (Math.cos(num)*2000), y2 - (Math.cos(num) * 10) + (Math.sin(num)*2000))
    c.lineTo(x2 + (Math.sin(num2) * 10) + (Math.cos(num)*2000), y2 - (Math.cos(num2) * 10) + (Math.sin(num)*2000))
    c.lineTo(x2 + (Math.sin(num2) * 10) - (Math.cos(num)*2000), y2 - (Math.cos(num2) * 10) - (Math.sin(num)*2000))
    c.lineTo(x2 + (Math.sin(num) * 10) - (Math.cos(num)*2000), y2 - (Math.cos(num) * 10) - (Math.sin(num)*2000))
    c.closePath()
    c.fillStyle = "#ff0000"
    ...
    projectile: function (x2, y2, num, i) {
...
const draw = function(timestamp) {
    ...
    */
    ...
    if (timestamp >= 5000 && attacks[8] != width/4){
        attacks[8] = width/4
        attacks[9] = height/4*3
        attacks[10] = "laser"
        attacks[11] = Math.PI
    }
    fpsCalc = timestamp
